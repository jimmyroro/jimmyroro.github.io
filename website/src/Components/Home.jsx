          ...
          <div class="card modal-card">
            ...
            <div class="card-body">
              ...
              <div className="col">
                <h5>Tech Stack</h5>
                <div className="row">
                  <p>MySQL, Sequelize, Express, React, Node, TypeScript, Socket.IO, WebRTC, TailwindCSS, Google Cloud</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal fade" id="organizeModal" tabindex="-1" role="dialog" aria-labelledby="organizePowerModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="card modal-card">
            ...
            <div class="card-body">
              <h5 class="card-title text-center">Organize Power</h5>
              <p class="card-text">Organize Power is a website that my team and I modified. It is a platform for creating movements that people can join, learn about, and comment on. It was built with React.js, Node, Express, and MySQL. We added user stories to it, including messaging, linking charities, and creating events in a calendar.</p>
