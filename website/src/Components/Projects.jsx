    ...
    <div class="card-group">
      <div class="card" style={mist}>
        ...
        <div class="card-body">
          ...
          <button href="https://upclose.uc.r.appspot.com/">
            Website
          </button>
          <button href="https://github.com/HearTogether/upclose">
            Repo
          </button>
        </div>
      </div>
      <div class="card" style={mist}>
        ...
        <div class="card-body">
          ...
          <button href="https://github.com/Apptonomy/organizepower"> 
            Repo
          </button>
        </div>
      </div>
      <div class="card" style={mist}>
        ...
        <div class="card-body">
          ...
          <button href="https://github.com/Apptonomy/Crawl">
            Repo
          </button>
        </div>
      </div>
