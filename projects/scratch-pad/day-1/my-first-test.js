...
function print(value) {
  ...
  console.log(value);
  /* we are printing to the console, which allows us to see what is happening within the code. it doesn't change what we are actually doing, but helps us to debug */
